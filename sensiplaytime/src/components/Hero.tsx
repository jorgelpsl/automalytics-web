    ...
    <section className="overflow-hidden bg-brand-cream">
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-12 sm:py-16 lg:grid-cols-2 lg:gap-8 lg:px-8 lg:py-20">
        ...
        <div className="relative mx-auto w-full max-w-xl animate-fade-up lg:max-w-none">
          <div
            aria-hidden="true"
            className="absolute -right-6 -top-10 h-3/4 w-3/4 rounded-[45%] bg-brand-yellow/30 blur-3xl"
          />
          <div
            aria-hidden="true"
            className="absolute -bottom-8 -left-6 h-2/3 w-2/3 rounded-[45%] bg-brand-mint/30 blur-3xl"
          />

          <div className="relative overflow-hidden rounded-tl-[24px] rounded-tr-[72px] rounded-br-[24px] rounded-bl-[72px] shadow-soft-lg sm:rounded-tr-[96px] sm:rounded-bl-[96px]">
            <Image
          ...
          <span className="absolute -bottom-4 left-6 inline-flex items-center gap-1.5 rounded-full bg-white px-3 py-2 text-xs font-semibold text-brand-dark shadow-soft-lg sm:left-9">
